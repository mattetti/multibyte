    ...
    module String #:nodoc:
      unless '1.9'.respond_to?(:force_encoding)
        ...
        module Unicode
          ...
          # Multibyte::Chars class which encapsulates the original string. A Unicode safe version of all
          ...
          #
          # For more information about the methods defined on the Chars proxy see Multibyte::Chars and
